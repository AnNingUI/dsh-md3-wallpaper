...
function tokensForScheme(
	...
	for (const [family, tonals] of Object.entries(FAMILY_TONALS)) {
		...
		for (const [suffix, pair] of Object.entries(tonals)) {
			tokens[`--dsw-static-${family}-${suffix}`] = hexFromArgb(
				palette.tone(pair[isDark ? 1 : 0]),
			);
		}
	}
	...
	tokens["--dsw-alias-interactive-bg-hover"] = rgbaFromArgb(
		palettes.neutral.tone(onSurface),
		0.06,
	);
	tokens["--dsw-alias-interactive-bg-active"] = rgbaFromArgb(
		palettes.neutral.tone(onSurface),
		0.1,
	);
	...
	tokens["--dsw-alias-scrollbar-bg-l1"] = hexFromArgb(
		palettes.neutral.tone(isDark ? 26 : 90),
	);
	tokens["--dsw-alias-scrollbar-bg-l2"] = hexFromArgb(
		palettes.neutral.tone(isDark ? 32 : 84),
	);
	tokens["--dsw-alias-scrollbar-hover-l1"] = hexFromArgb(
		palettes.neutral.tone(isDark ? 40 : 74),
	);
	tokens["--dsw-alias-scrollbar-hover-l2"] = hexFromArgb(
		palettes.neutral.tone(isDark ? 45 : 68),
	);
...
export function buildMdSysTokens(
	...
	tokens["--md-sys-color-surface-container-lowest"] = hexFromArgb(
		neutral.tone(isDark ? 4 : 100),
	);
	tokens["--md-sys-color-surface-container-low"] = hexFromArgb(
		neutral.tone(isDark ? 10 : 96),
	);
	tokens["--md-sys-color-surface-container"] = hexFromArgb(
		neutral.tone(isDark ? 12 : 94),
	);
	tokens["--md-sys-color-surface-container-high"] = hexFromArgb(
		neutral.tone(isDark ? 17 : 92),
	);
	tokens["--md-sys-color-surface-container-highest"] = hexFromArgb(
		neutral.tone(isDark ? 22 : 90),
	);
	...
	tokens["--md-sys-color-surface-dim"] = hexFromArgb(
		neutral.tone(isDark ? 6 : 87),
	);
	tokens["--md-sys-color-surface-bright"] = hexFromArgb(
		neutral.tone(isDark ? 24 : 98),
	);
