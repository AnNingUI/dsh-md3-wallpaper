...
describe("dev hot reload helpers", () => {
  ...
  it("discovers the bundle src from the page script tags, with fallback", () => {
    ...
    script.src = "/plugins/@AnNingUI/dsh-client-ui-skin-md3-wallpaper/client.js?rev=abc123";
    document.head.appendChild(script);
    expect(bundleSrc()).toBe(script.src);
    script.remove();
    expect(bundleSrc()).toBe("/plugins/@AnNingUI/dsh-client-ui-skin-md3-wallpaper/client.js");
  });
});
